...
const FAQItem = ({ question, answer }) => (
  <div className="flex flex-col justify-between flex-1 p-12 bg-green-500 rounded-xl border border-solid border-neutral-800 min-h-[320px] max-w-[30vw] min-w-[300px] flex-grow max-md:w-full max-md:min-h-auto max-md:max-w-full">
