...
import book from "../../assets/booksDownload/budget.pdf"
...
return (
  <div className=" p-[5%]">
    ...
    <Button
      ...
      className="inline-block text-[#263871] hover:text-green-500 rounded-lg py-4 px-10 lg:px-14 text-7xl md:text-6xl lg:text-7xl min-w-[250px] lg:min-w-[250px] text-center transition-all duration-300 bg-white"
      style={{
        border: '5px solid',
        borderRadius: '12px',
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center">
            <Button color="success" onClick={() => setOpenModal(false)} onSubmit={onSubmit}>
              <a href="https://drive.usercontent.google.com/u/0/uc?id=1Uhy8_aqU_JTZOhNulnhymsyS2iBnQFmv&export=download" download={'https://drive.usercontent.google.com/u/0/uc?id=1Uhy8_aqU_JTZOhNulnhymsyS2iBnQFmv&export=download'}>Download Now</a>
            </Button>
          </div>
        </div>
      </Modal.Body>
